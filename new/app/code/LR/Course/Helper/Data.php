...
{
    /**
     * Path to store config where count of course posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'course/view/items_per_page';
    ...
    /**
     * Remove Course item image by image filename
     *
     ...
     * @return bool|string
     */
    public function resize(\LR\Course\Model\Course $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Course Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Course Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getCoursePerPage()
    {
